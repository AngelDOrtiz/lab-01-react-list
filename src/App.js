...
class App extends Component {
  ...
  handleSearch = ({ nameFilter, sortField }) => {
    ...
    //this is to remove case sensitivity
    const nameRegex = new RegExp(nameFilter, 'i');

    const searchedPotions = potionData
      .filter(potion => {
    ...
    this.setState({ potions: searchedPotions });
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <PotionSearch onSearch={this.handleSearch}></PotionSearch>
        <Footer/>
      </div>
    );
  }
